...
class MyGame(arcade.Window): #býr til Klasa
    ...
    def setup(self):
        ...
        enemy = arcade.Sprite("C:/Git/Skoli-haust-2020/Forritun/Verkefni með einkunn/Lokaverkefni/images/character_zombie_idle.png", SPRITE_SCALING)#kallar í myndina
        ...
        # Setur mörk til vinstri / hægri sem óvinurinn kemst ekki yfir
