...
class MyGame(arcade.Window):
    ...
    def setup(self):
        ...
        for x in range(0, SCREEN_WIDTH, SPRITE_SIZE * 5):
            wall = arcade.Sprite(":resources:images/tiles/boxCrate_double.pngC:\Git\Skoli-haust-2020\Forritun\Verkefni með einkunn\Lokaverkefni\images\boxCrate_double.png", SPRITE_SCALING)
